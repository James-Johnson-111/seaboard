...
const PurchaseOrder = () => {
    ...
    return (
        <>
                ...
                <div className="PurchaseOrder-content">
                    ...
                    <div className="d-lg-flex justify-content-center second">
                        <div className="leftRight mr-3">
                            ...
                            <button data-toggle="modal" data-target="#add_vender" className="btn plus_specifications" title="Add Specification"><i class="las la-plus"></i></button>
                        </div>
                        <div className="leftRight mr-3">
                            <h6 className="text-uppercase bg-dark text-white p-1 px-3">ship to</h6>
                            <button data-toggle="modal" data-target="#shipTo" className="btn plus_specifications" title="Add Specification"><i class="las la-plus"></i></button>
                        </div>
                    </div>
                    <div className="table-responsive">
                        ...
                        <button data-toggle="modal" data-target="#shipTo" className="btn plus_specifications my-0" title="Add Specification"><i class="las la-plus"></i></button>
                    </div>
            ...
            <div class="modal fade" id="add_vender" tabindex="-1" role="dialog" aria-labelledby="add_venderLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="add_venderLabel">Add Vender</h5>
            ...
            <div class="modal fade" id="shipTo" tabindex="-1" role="dialog" aria-labelledby="shipToLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="shipToLabel">Ship To</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
