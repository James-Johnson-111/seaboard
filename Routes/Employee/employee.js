...
router.post('/employeedata', ( req, res ) => {
    ...
    const { Name, FatherName, Dob, PoB, ImageName, RsdtAddress, PrmtAddress, Emergency_contact_person, Emergency_contact_number, landlineHome, personal_no, cnic, cnic_PoI , cnic_DoI , cnic_DoE , password, UserName, education, CNICImageName, CVImageName, AddressImageName, EducationImageName } = req.body;
